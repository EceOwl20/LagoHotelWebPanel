...
const BannerDark = ({img,header,span,text}) => {
  return (
    <div className='flex w-screen h-screen lg:min-h-screen items-center justify-center bg-center bg-cover relative' role="img" aria-label={img.alt || undefined} style={{ backgroundImage: `url(${img.src})` }}>
