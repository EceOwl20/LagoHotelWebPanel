...
const groupVisuals = {
  ...
  beachpools: { icon: GiAtSea, iconClass: "bg-blue-100 text-blue-700", itemIconClass: "bg-blue-100/80 text-blue-700", headerClass: "bg-blue-50/60", borderClass: "border-blue-200/70", accentClass: "bg-blue-600" },
};
