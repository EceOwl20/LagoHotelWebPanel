"use client";
import EntertainmentPageFields from "../../icerikler/EntertainmentPageFields";
...
const AzuraPageContentEditor = forwardRef(function AzuraPageContentEditor({ activeLocale, onDirtyChange, pageKey = "spawellness" }, ref) {
  ...
  const Fields = pageKey === "entertainment" ? EntertainmentPageFields : pageKey === "bars" ? BarCafesPageFields : pageKey === "kidsclub" ? KidsClubPageFields : pageKey === "beachpools" ? BeachPoolsPageFields : SpaPageFields;
  const label = pageKey === "entertainment" ? "Eğlence" : pageKey === "bars" ? "Barlar" : pageKey === "kidsclub" ? "Çocuk Kulübü" : pageKey === "beachpools" ? "Plaj ve Havuzlar" : pageKey === "spor" ? "Spor" : "Spa & Wellness";
